...
__all__ = ['ResNet', 'resnet50_ibn_a_old', 'resnet101_ibn_a_old',
           'resnet152_ibn_a_old']
...
def resnet50_ibn_a_old(pretrained=False, **kwargs):
...
def resnet101_ibn_a_old(pretrained=False, **kwargs):
...
def resnet152_ibn_a_old(pretrained=False, **kwargs):
